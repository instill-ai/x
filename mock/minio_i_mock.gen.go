...
type MinioIMock struct {
	...
	funcUploadFileBytes          func(ctx context.Context, logger *zap.Logger, filePath string, fileBytes []byte, fileMimeType string) (url string, objectInfo *miniogo.ObjectInfo, err error)
	inspectFuncUploadFileBytes   func(ctx context.Context, logger *zap.Logger, filePath string, fileBytes []byte, fileMimeType string)
	...
	if mmDeleteFile.DeleteFileMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.logger != nil && !minimock.Equal(*mm_want_ptrs.logger, mm_got.logger) {
				mmDeleteFile.t.Errorf("MinioIMock.DeleteFile got unexpected parameter logger, want: %#v, got: %#v%s\n", *mm_want_ptrs.logger, mm_got.logger, minimock.Diff(*mm_want_ptrs.logger, mm_got.logger))
			}
...
func (mmGetFile *MinioIMock) GetFile(ctx context.Context, logger *zap.Logger, filePath string) (ba1 []byte, err error) {
	...
	if mmGetFile.GetFileMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.logger != nil && !minimock.Equal(*mm_want_ptrs.logger, mm_got.logger) {
				mmGetFile.t.Errorf("MinioIMock.GetFile got unexpected parameter logger, want: %#v, got: %#v%s\n", *mm_want_ptrs.logger, mm_got.logger, minimock.Diff(*mm_want_ptrs.logger, mm_got.logger))
			}
...
func (mmGetFilesByPaths *MinioIMock) GetFilesByPaths(ctx context.Context, logger *zap.Logger, filePaths []string) (fa1 []mm_minio.FileContent, err error) {
	...
	if mmGetFilesByPaths.GetFilesByPathsMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.logger != nil && !minimock.Equal(*mm_want_ptrs.logger, mm_got.logger) {
				mmGetFilesByPaths.t.Errorf("MinioIMock.GetFilesByPaths got unexpected parameter logger, want: %#v, got: %#v%s\n", *mm_want_ptrs.logger, mm_got.logger, minimock.Diff(*mm_want_ptrs.logger, mm_got.logger))
			}
...
func (mmUploadFileBytes *mMinioIMockUploadFileBytes) Expect(ctx context.Context, logger *zap.Logger, filePath string, fileBytes []byte, fileMimeType string) *mMinioIMockUploadFileBytes {
	...
	mmUploadFileBytes.defaultExpectation.params = &MinioIMockUploadFileBytesParams{ctx, logger, filePath, fileBytes, fileMimeType}
...
// ExpectFilePathParam3 sets up expected param filePath for MinioI.UploadFileBytes
func (mmUploadFileBytes *mMinioIMockUploadFileBytes) ExpectFilePathParam3(filePath string) *mMinioIMockUploadFileBytes {
	if mmUploadFileBytes.mock.funcUploadFileBytes != nil {
		mmUploadFileBytes.mock.t.Fatalf("MinioIMock.UploadFileBytes mock is already set by Set")
	}
...
// ExpectFileBytesParam4 sets up expected param fileBytes for MinioI.UploadFileBytes
func (mmUploadFileBytes *mMinioIMockUploadFileBytes) ExpectFileBytesParam4(fileBytes []byte) *mMinioIMockUploadFileBytes {
	if mmUploadFileBytes.mock.funcUploadFileBytes != nil {
		mmUploadFileBytes.mock.t.Fatalf("MinioIMock.UploadFileBytes mock is already set by Set")
	}
...
// ExpectFileMimeTypeParam5 sets up expected param fileMimeType for MinioI.UploadFileBytes
func (mmUploadFileBytes *mMinioIMockUploadFileBytes) ExpectFileMimeTypeParam5(fileMimeType string) *mMinioIMockUploadFileBytes {
	if mmUploadFileBytes.mock.funcUploadFileBytes != nil {
		mmUploadFileBytes.mock.t.Fatalf("MinioIMock.UploadFileBytes mock is already set by Set")
	}
...
func (mmUploadFileBytes *mMinioIMockUploadFileBytes) Inspect(f func(ctx context.Context, logger *zap.Logger, filePath string, fileBytes []byte, fileMimeType string)) *mMinioIMockUploadFileBytes {
...
func (mmUploadFileBytes *mMinioIMockUploadFileBytes) Set(f func(ctx context.Context, logger *zap.Logger, filePath string, fileBytes []byte, fileMimeType string) (url string, objectInfo *miniogo.ObjectInfo, err error)) *MinioIMock {
	if mmUploadFileBytes.defaultExpectation != nil {
...
// Then helper
func (mmUploadFileBytes *mMinioIMockUploadFileBytes) When(ctx context.Context, logger *zap.Logger, filePath string, fileBytes []byte, fileMimeType string) *MinioIMockUploadFileBytesExpectation {
	if mmUploadFileBytes.mock.funcUploadFileBytes != nil {
		mmUploadFileBytes.mock.t.Fatalf("MinioIMock.UploadFileBytes mock is already set by Set")
	}
	...
	expectation := &MinioIMockUploadFileBytesExpectation{
		...
		params: &MinioIMockUploadFileBytesParams{ctx, logger, filePath, fileBytes, fileMimeType},
	}
...
func (mmUploadFileBytes *MinioIMock) UploadFileBytes(ctx context.Context, logger *zap.Logger, filePath string, fileBytes []byte, fileMimeType string) (url string, objectInfo *miniogo.ObjectInfo, err error) {
	...
	if mmUploadFileBytes.inspectFuncUploadFileBytes != nil {
		mmUploadFileBytes.inspectFuncUploadFileBytes(ctx, logger, filePath, fileBytes, fileMimeType)
	}

	mm_params := MinioIMockUploadFileBytesParams{ctx, logger, filePath, fileBytes, fileMimeType}
	...
	if mmUploadFileBytes.UploadFileBytesMock.defaultExpectation != nil {
		...
		mm_got := MinioIMockUploadFileBytesParams{ctx, logger, filePath, fileBytes, fileMimeType}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.logger != nil && !minimock.Equal(*mm_want_ptrs.logger, mm_got.logger) {
				mmUploadFileBytes.t.Errorf("MinioIMock.UploadFileBytes got unexpected parameter logger, want: %#v, got: %#v%s\n", *mm_want_ptrs.logger, mm_got.logger, minimock.Diff(*mm_want_ptrs.logger, mm_got.logger))
			}
	...
	if mmUploadFileBytes.funcUploadFileBytes != nil {
		return mmUploadFileBytes.funcUploadFileBytes(ctx, logger, filePath, fileBytes, fileMimeType)
	}
	mmUploadFileBytes.t.Fatalf("Unexpected call to MinioIMock.UploadFileBytes. %v %v %v %v %v", ctx, logger, filePath, fileBytes, fileMimeType)
	return
}
