...
// NewGRPCOptionsAndCreds creates a new gRPC server options and credentials
func NewGRPCOptionsAndCreds(options ...Option) ([]grpc.ServerOption, credentials.TransportCredentials, error) {
