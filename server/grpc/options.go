...
func NewServerOptionsAndCreds(options ...Option) ([]grpc.ServerOption, error) {
	...
	grpcServerOpts = append(grpcServerOpts, []grpc.ServerOption{
		grpc.StreamInterceptor(grpcmiddleware.ChainStreamServer(
			...
			interceptor.TracingStreamServerInterceptor(opts.ServiceName, opts.ServiceVersion, opts.SetOTELServerHandler),
		...
		grpc.UnaryInterceptor(grpcmiddleware.ChainUnaryServer(
			...
			interceptor.TracingUnaryServerInterceptor(opts.ServiceName, opts.ServiceVersion, opts.SetOTELServerHandler),
